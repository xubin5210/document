 ...
 * @date 2015年6月24日 下午4:20:32
 * @说明 代码版权归 杭州反盗版中心有限公司 所有
 */

public class EmailUtils {// 要发送Mail地址
	...
	public int sendMail() throws IOException, MessagingException {
		...
		EmailAuthenticator auth = new EmailAuthenticator("705460418@qq.com",
				"zhuwentao&1223");
		...
		try {
			...
			try {
				trans.connect(smtpHost, "705460418@qq.com", "zhuwentao&1223");
