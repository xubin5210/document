 ...
 * @author zhuwt  
 * @Description: 图片缩放  
 * @Package com.ciapc.tzd.modules.newgd.trends   
 * @Title: ImageZoomView.java   
 * @date 2014-3-14 下午5:34:29   
 * @version V1.0 
	...
	public ImageZoomView(Context context, AttributeSet attrs) {
		...
		public boolean onTouchEvent(MotionEvent event) {
			...
			case MotionEvent.ACTION_UP:
				...
				lastXMove = -1;
				lastYMove = -1;
				float nowTime = System.currentTimeMillis() - time;
				if(nowTime <100){
					if(null != mActivity)
						mActivity.finish();
				}
...
//					Matrix m = new Matrix();
//					//图片按一定比例先放大显示 然后在居中
//					m.postScale(Math.round(getWidth()/bitmapWidth),Math.round(getHeight()/2)/bitmapHeight);
//					sourceBitmap=Bitmap.createBitmap(sourceBitmap, 0, 0, bitmapWidth, bitmapHeight, m, true);
					...
					currentBitmapWidth = sourceBitmap.getWidth();
					currentBitmapHeight = sourceBitmap.getHeight();
				}
				canvas.drawBitmap(sourceBitmap, matrix, null);
			}
		}
